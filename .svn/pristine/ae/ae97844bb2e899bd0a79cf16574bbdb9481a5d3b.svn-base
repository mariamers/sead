          ...
          {({ open }) => (
            <>
                ...
                <div className="flex h-16 items-center justify-between">
                        ...
                        {navigation.map((item) => (
                          <a
                            ...
                            className={classNames(
                              item.current
                                ? 'bg-cor2 text-white'
                                : 'text-white hover:bg-cor2 hover:text-white',
                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      <button
                        type="button"
                        className="relative rounded-full bg-cor2 p-1 text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-cor2"
                      >
              ...
              <Disclosure.Panel className="md:hidden">
                <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                  {navigation.map((item) => (
                    <Disclosure.Button
                      ...
                      href={item.href}
                      className={classNames(
                        item.current ? 'bg-cor2 text-white' : 'text-gray-300 hover:bg-cor2 hover:text-white',
                ...
                <div className="border-t border-cor2 pb-3 pt-4">
                  <div className="flex items-center px-5">
                    ...
                    <button
                      type="button"
                      className="relative ml-auto flex-shrink-0 rounded-full bg-cor2 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-cor2"
                    >
                      <span className="absolute -inset-1.5" />
                      <span className="sr-only">View notifications</span>
                      <BellIcon className="h-6 w-6" aria-hidden="true" />
                  ...
                  <div className="mt-3 space-y-1 px-2">
                    {userNavigation.map((item) => (
                      <Disclosure.Button
                        ...
                        as="a"
                        href={item.href}
                        className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-cor2 hover:text-white"
                      >
                        {item.name}
                      </Disclosure.Button>
                    ))}
