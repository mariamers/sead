...
function CheckboxButton(props) {
    ...
    const labelStyle = `flex items-center py-2 pr-6 pl-2 border-2 rounded-full cursor-pointer text-sm transition 
    ...
    return (
        <div>
            <label className={labelStyle}>
                <input
                    type="checkbox"
                    className="checked:text-gray-950 checked:bg-gray-950 rounded-full cursor-pointer mr-2 select-none focus:outline-none focus:ring-offset-0 focus:ring-0"
